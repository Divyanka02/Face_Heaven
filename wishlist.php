...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Face Heaven - Wishlist</title>
		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-primary" style="border-color: #01142c;">
					<div class="panel-heading" style="background-color: #01142c; border: #01142c; font-size: 20px;">Your Wishlist</div>
					<div class="panel-body">
